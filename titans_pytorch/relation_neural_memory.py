...
class RelationNeuralMemory(Module):
    def __init__(
        self,
        dim,
        ...
        # self.to_queries = Sequential(LinearNoBias(dim, dim_inner), activation)  # by xl
        self.to_queries = nn.Identity()  # by xl
        self.to_keys = nn.Identity()  # by xl
        self.to_values = nn.Identity()  # by xl
